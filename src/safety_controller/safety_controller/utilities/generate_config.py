...
def generate_random_scenarios(num_scenarios=5):
    ...
    scenario_types = ["static", "sudden_ped"]
    scenarios = []
...
def generate_yaml():
    data = {
        ...
        "controller": ["MPC-DCBF", "MPC-DRCBF", "MPC-DHOCBF","MPC-CBF-QP", "MPC-RCBF-QP", "MPC-HOCBF-QP"],
        ...
        "scenarios": generate_random_scenarios(3),

    }
    
    with open("utilities/config_IFAC.yaml", "w") as file:
